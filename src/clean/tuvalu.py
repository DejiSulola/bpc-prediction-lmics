...
class Tuvalu(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Tuvalu.
    """
    ...
    SAVE_LOCATION = 'data/plots/tuvalu'
    DATA_LOCATION = 'data/cleaned/tuvalu.csv'
    FILENAME = 'tuvalu.png'
