...
class Grenada(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Grenada.
    """
    ...
    SAVE_LOCATION = 'data/plots/grenada'
    DATA_LOCATION = 'data/cleaned/grenada.csv'
    FILENAME = 'grenada.png'
