...
class Tanzania(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Tanzania.
    """
    ...
    TOTAL_CHOLESTEROL = 'b11'    # mg/dL
    URINARY_SODIUM = 'b14'      # mg/dL
    URINARY_CREATININE = 'b15'  # mg/dL
    TRIGLYCERIDES = 'b10'
    HDL_CHOLESTEROL = 'b17'

    SAVE_LOCATION = 'data/plots/tanzania'
    DATA_LOCATION = 'data/cleaned/tanzania.csv'
