...
class Madagascar(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Madagascar.
    """
    ...
    SAVE_LOCATION = 'data/plots/madagascar'
    DATA_LOCATION = 'data/cleaned/madagascar.csv'
    FILENAME = 'madagascar.png'
