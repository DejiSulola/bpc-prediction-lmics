...
class Mongolia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Mongolia.
    """
    ...
    SAVE_LOCATION = 'data/plots/mongolia'
    DATA_LOCATION = 'data/cleaned/mongolia.csv'
    FILENAME = 'mongolia.png'
