...
class Tokelau(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Tokelau.
    """
    ...
    EARNINGS = 'c10'
    CONVERSION_FACTOR = 1.59658
    CURRENTLY_SMOKE_TOBACCO = 't1'
    AGE_STARTED_SMOKING = 't3'
    TOBACCO_COLS = ['t5a', 't5b', 't5f']
    ...
    SAVE_LOCATION = 'data/plots/tokelau'
    DATA_LOCATION = 'data/cleaned/tokelau.csv'
    FILENAME = 'tokelau.png'
