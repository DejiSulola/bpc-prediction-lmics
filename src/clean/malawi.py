...
class Malawi(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Malawi.
    """
    ...
    SAVE_LOCATION = 'data/plots/malawi'
    DATA_LOCATION = 'data/cleaned/malawi.csv'
    FILENAME = 'malawi.png'
