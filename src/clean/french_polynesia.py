...
class FrenchPolynesia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing FrenchPolynesia.
    """
    ...
    SAVE_LOCATION = 'data/plots/french_polynesia'
    DATA_LOCATION = 'data/cleaned/french_polynesia.csv'
    FILENAME = 'french_polynesia.png'
