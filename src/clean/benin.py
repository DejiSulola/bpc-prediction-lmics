...
class Benin(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Benin.
    """
    ...
    SAVE_LOCATION = 'data/plots/benin'
    DATA_LOCATION = 'data/cleaned/benin.csv'
    FILENAME = 'benin.png'
