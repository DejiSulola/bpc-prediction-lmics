...
class Comoros(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Comoros.
    """
    ...
    SAVE_LOCATION = 'data/plots/comoros'
    DATA_LOCATION = 'data/cleaned/comoros.csv'
    FILENAME = 'comoros.png'
