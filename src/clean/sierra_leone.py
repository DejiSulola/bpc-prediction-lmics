...
class SierraLeone(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing SierraLeone.
    """
    ...
    SAVE_LOCATION = 'data/plots/sierra_leone'
    DATA_LOCATION = 'data/cleaned/sierra_leone.csv'
    FILENAME = 'sierra_leone.png'
