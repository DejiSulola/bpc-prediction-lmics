...
class Uganda(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Uganda.
    """
    ...
    SAVE_LOCATION = 'data/plots/uganda'
    DATA_LOCATION = 'data/cleaned/uganda.csv'
    FILENAME = 'uganda.png'
