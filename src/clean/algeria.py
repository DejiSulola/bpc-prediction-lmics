...
class Algeria(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Algeria.
    """
    ...
    URINARY_SODIUM = 'b19'      # mg/dL
    URINARY_CREATININE = 'b18'  # mg/dL
    TRIGLYCERIDES = 'b15'
    HDL_CHOLESTEROL = 'b17'

    SAVE_LOCATION = 'data/plots/algeria'
    DATA_LOCATION = 'data/cleaned/algeria.csv'
    FILENAME = 'algeria.png'
