...
class Ghana(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Ghana.
    """
    ...
    SAVE_LOCATION = 'data/plots/ghana'
    DATA_LOCATION = 'data/cleaned/ghana.csv'
    FILENAME = 'ghana.png'
