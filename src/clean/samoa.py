...
class Samoa(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Samoa.
    """
    ...
    SAVE_LOCATION = 'data/plots/samoa'
    DATA_LOCATION = 'data/cleaned/samoa.csv'
    FILENAME = 'samoa.png'
