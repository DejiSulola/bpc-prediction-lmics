...
class Micronesia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Micronesia.
    """
    ...
    SAVE_LOCATION = 'data/plots/micronesia'
    DATA_LOCATION = 'data/cleaned/micronesia.csv'
