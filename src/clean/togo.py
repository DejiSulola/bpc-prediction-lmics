...
class Togo(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Togo.
    """
    ...
    SAVE_LOCATION = 'data/plots/togo'
    DATA_LOCATION = 'data/cleaned/togo.csv'
    FILENAME = 'togo.png'
