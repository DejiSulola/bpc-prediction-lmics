...
class Afghanistan(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Afghanistan.
    """
    ...
    SAVE_LOCATION = 'data/plots/afghanistan'
    DATA_LOCATION = 'data/cleaned/afghanistan.csv'
