...
class CoteDivoire(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing CoteDivoire.
    """
    ...
    SAVE_LOCATION = 'data/plots/cote_divoire'
    DATA_LOCATION = 'data/cleaned/cote_divoire.csv'
    FILENAME = 'cote_divoire.png'
