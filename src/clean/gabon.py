...
class Gabon(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Gabon.
    """
    ...
    SAVE_LOCATION = 'data/plots/gabon'
    DATA_LOCATION = 'data/cleaned/gabon.csv'
    FILENAME = 'gabon.png'
