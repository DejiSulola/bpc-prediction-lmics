...
class Rwanda(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Rwanda.
    """
    ...
    TAKEN_CHOLESTEROL_ORAL_TREATMENT = ''
    HAD_HEART_ATTACK = ''
    TAKING_HEART_DISEASE_MEDICATION = ''
    ...
    SAVE_LOCATION = 'data/plots/rwanda'
    DATA_LOCATION = 'data/cleaned/rwanda.csv'
    FILENAME = 'rwanda.png'
