...
class DemocraticRepublicOfTheCongo(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing DemocraticRepublicOfTheCongo.
    """
    ...
    SAVE_LOCATION = 'data/plots/democratic_republic_of_the_congo'
    DATA_LOCATION = 'data/cleaned/democratic_republic_of_the_congo.csv'
