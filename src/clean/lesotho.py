...
class Lesotho(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Lesotho.
    """
    ...
    SAVE_LOCATION = 'data/plots/lesotho'
    DATA_LOCATION = 'data/cleaned/lesotho.csv'
    FILENAME = 'lesotho.png'
