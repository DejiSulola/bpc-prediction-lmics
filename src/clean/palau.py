...
class Palau(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Palau.
    """
    ...
    SAVE_LOCATION = 'data/plots/palau'
    DATA_LOCATION = 'data/cleaned/palau.csv'
    FILENAME = 'palau.png'
