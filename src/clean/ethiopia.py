...
class Ethiopia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Ethiopia.
    """
    ...
    SAVE_LOCATION = 'data/plots/ethiopia'
    DATA_LOCATION = 'data/cleaned/ethiopia.csv'
