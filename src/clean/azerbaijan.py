...
class Azerbaijan(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Azerbaijan.
    """
    ...
    SAVE_LOCATION = 'data/plots/azerbaijan'
    DATA_LOCATION = 'data/cleaned/azerbaijan.csv'
