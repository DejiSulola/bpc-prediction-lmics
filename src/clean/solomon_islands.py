...
class SolomonIslands(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Solomon Islands.
    """
    ...
    SAVE_LOCATION = 'data/plots/solomon_islands'
    DATA_LOCATION = 'data/cleaned/solomon_islands.csv'
    FILENAME = 'solomon_islands.png'
