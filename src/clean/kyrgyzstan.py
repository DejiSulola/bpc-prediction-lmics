...
class Kyrgyzstan(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Kyrgyzstan.
    """
    ...
    EARNINGS = 'c10'
    CONVERSION_FACTOR = 86.9697
    CURRENTLY_SMOKE_TOBACCO = 't1'
    AGE_STARTED_SMOKING = 't3'
    TOBACCO_COLS = ['t5a', 't5b', 't5c', 't5e', 't5f']
    ...
    SAVE_LOCATION = 'data/plots/kyrgyzstan'
    DATA_LOCATION = 'data/cleaned/kyrgyzstan.csv'
    FILENAME = 'kyrgyzstan.png'
