...
class CentralAfricanRepublic(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing CentralAfricanRepublic.
    """
    ...
    SAVE_LOCATION = 'data/plots/central_african_republic'
    DATA_LOCATION = 'data/cleaned/central_african_republic.csv'
