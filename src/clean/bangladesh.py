...
class Bangladesh(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Bangladesh.
    """
    ...
    EARNINGS = 'c10'
    CONVERSION_FACTOR =  105.933
    CURRENTLY_SMOKE_TOBACCO = 't1'
    AGE_STARTED_SMOKING = 't3'
    TOBACCO_COLS = ['t5a', 't5b', 't5c', 't5d', 't5e', 't5f', 't5g']
    ...
    SAVE_LOCATION = 'data/plots/bangladesh'
    DATA_LOCATION = 'data/cleaned/bangladesh.csv'
    FILENAME = 'bangladesh.png'
