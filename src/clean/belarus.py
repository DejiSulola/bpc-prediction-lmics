...
class Belarus(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Belarus.
    """
    ...
    SAVE_LOCATION = 'data/plots/belarus'
    DATA_LOCATION = 'data/cleaned/belarus.csv'
    FILENAME = 'belarus.png'
