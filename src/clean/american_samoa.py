...
class AmericanSamoa(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing AmericanSamoa.
    """
    ...
    READING1_SYSTOLIC = 'm12a'
    READING1_DIASTOLIC = 'm12b'
    READING2_SYSTOLIC = 'm13a'
    READING2_DIASTOLIC = 'm13b'
    READING3_SYSTOLIC = 'm11a'
    READING3_DIASTOLIC = 'm11b'
    ...
    TOTAL_CHOLESTEROL = 'b7mg'    # mg/dL
    URINARY_SODIUM = 'b14'      # mg/dL
    URINARY_CREATININE = 'b15'  # mg/dL
    TRIGLYCERIDES = 'b16'
    HDL_CHOLESTEROL = 'b17'

    SAVE_LOCATION = 'data/plots/american_samoa'
    DATA_LOCATION = 'data/cleaned/american_samoa.csv'
    FILENAME = 'american_samoa.png'
    ...
    def run_cleaning(self):
        ...
        """
        properties = {'taken_diabetes_drugs': {'drug_list': [self.TAKEN_DIABETES_DRUGS_INSULIN,
                                  self.TAKEN_DIABETES_DRUGS_ORAL, self.TAKEN_DIABETES_DRUGS_DIET]}}
