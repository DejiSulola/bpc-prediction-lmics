...
class Fiji(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Fiji.
    """
    ...
    SAVE_LOCATION = 'data/plots/fiji'
    DATA_LOCATION = 'data/cleaned/fiji.csv'
    FILENAME = 'fiji.png'
