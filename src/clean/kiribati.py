...
class Kiribati(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Kiribati.
    """
    ...
    EARNINGS = 'c10'
    CONVERSION_FACTOR = 1.43495
    CURRENTLY_SMOKE_TOBACCO = 't1'
    AGE_STARTED_SMOKING = 't3'
    TOBACCO_COLS = ['t5a', 't5b', 't5c', 't5f']
    ...
    SAVE_LOCATION = 'data/plots/kiribati'
    DATA_LOCATION = 'data/cleaned/kiribati.csv'
    FILENAME = 'kiribati.png'
