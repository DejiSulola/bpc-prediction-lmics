...
class CaymanIslands(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing CaymanIslands.
    """
    ...
    SAVE_LOCATION = 'data/plots/cayman_islands'
    DATA_LOCATION = 'data/cleaned/cayman_islands.csv'
    FILENAME = 'cayman_islands.png'
