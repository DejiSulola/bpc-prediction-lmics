...
class Eswatini(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Eswatini.
    """
    ...
    SAVE_LOCATION = 'data/plots/eswatini'
    DATA_LOCATION = 'data/cleaned/eswatini.csv'
    FILENAME = 'eswatini.png'
