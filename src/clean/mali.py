...
class Mali(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Mali.
    """
    ...
    READING2_BPM = 'm16b'
    READING3_BPM = 'm16c'
    FASTING_BLOOD_GLUCOSE = 'b5a' # mg/dL
    ...
    SAVE_LOCATION = 'data/plots/mali'
    DATA_LOCATION = 'data/cleaned/mali.csv'
    FILENAME = 'mali.png'
