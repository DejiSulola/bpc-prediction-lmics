...
class BritishVirginIslands(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing BritishVirginIslands.
    """
    ...
    SAVE_LOCATION = 'data/plots/british_virgin_islands'
    DATA_LOCATION = 'data/cleaned/british_virgin_islands.csv'
    FILENAME = 'british_virgin_islands.png'
