...
class Eritrea(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Eritrea.
    """
    ...
    SAVE_LOCATION = 'data/plots/eritrea'
    DATA_LOCATION = 'data/cleaned/eritrea.csv'
    FILENAME = 'eritrea.png'
