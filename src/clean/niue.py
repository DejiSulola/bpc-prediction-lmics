...
class Niue(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Niue.
    """
    ...
    SAVE_LOCATION = 'data/plots/niue'
    DATA_LOCATION = 'data/cleaned/niue.csv'
    FILENAME = 'niue.png'
