...
class Bhutan(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Bhutan.
    """
    ...
    MARITAL_STATUS = 'c7'
    WORK_STATUS = 'c8'
    PPL_IN_HOUSEHOLD = 'c9x'
    CONVERSION_FACTOR = 82.6984
    ...
    SAVE_LOCATION = 'data/plots/bhutan'
    DATA_LOCATION = 'data/cleaned/bhutan.csv'
    FILENAME = 'bhutan.png'
