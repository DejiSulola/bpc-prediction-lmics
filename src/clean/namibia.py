...
class Namibia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Namibia.
    """
    ...
    SAVE_LOCATION = 'data/plots/namibia'
    DATA_LOCATION = 'data/cleaned/namibia.csv'
