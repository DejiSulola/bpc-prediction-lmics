...
class Ecuador(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Ecuador.
    """
    ...
    SAVE_LOCATION = 'data/plots/ecuador'
    DATA_LOCATION = 'data/cleaned/ecuador.csv'
    FILENAME = 'ecuador.png'
