...
class Niger(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Niger.
    """
    ...
    SAVE_LOCATION = 'data/plots/niger'
    DATA_LOCATION = 'data/cleaned/niger.csv'
    FILENAME = 'niger.png'
