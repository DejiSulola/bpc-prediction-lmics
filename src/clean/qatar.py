...
class Qatar(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Qatar.
    """
    ...
    SAVE_LOCATION = 'data/plots/qatar'
    DATA_LOCATION = 'data/cleaned/qatar.csv'
    FILENAME = 'qatar.png'
