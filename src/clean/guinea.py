...
class Guinea(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Guinea.
    """
    ...
    SAVE_LOCATION = 'data/plots/guinea'
    DATA_LOCATION = 'data/cleaned/guinea.csv'
    FILENAME = 'guinea.png'
