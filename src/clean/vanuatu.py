...
class Vanuatu(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Vanuatu.
    """
    ...
    EARNINGS = 'c10'
    CONVERSION_FACTOR = 116.579
    CURRENTLY_SMOKE_TOBACCO = 't1a'
    ...
    SAVE_LOCATION = 'data/plots/vanuatu'
    DATA_LOCATION = 'data/cleaned/vanuatu.csv'
    FILENAME = 'vanuatu.png'
