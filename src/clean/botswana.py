...
class Botswana(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Botswana.
    """
    ...
    SAVE_LOCATION = 'data/plots/botswana'
    DATA_LOCATION = 'data/cleaned/botswana.csv'
    FILENAME = 'botswana.png'
