...
class Guyana(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Guyana.
    """
    ...
    SAVE_LOCATION = 'data/plots/guyana'
    DATA_LOCATION = 'data/cleaned/guyana.csv'
    FILENAME = 'guyana.png'
