...
class Nauru(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Nauru.
    """
    ...
    SAVE_LOCATION = 'data/plots/nauru'
    DATA_LOCATION = 'data/cleaned/nauru.csv'
    FILENAME = 'nauru.png'
