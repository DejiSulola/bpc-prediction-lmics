...
class Chad(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Chad.
    """
    ...
    SAVE_LOCATION = 'data/plots/chad'
    DATA_LOCATION = 'data/cleaned/chad.csv'
    FILENAME = 'chad.png'
