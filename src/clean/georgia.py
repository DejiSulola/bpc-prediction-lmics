...
class Georgia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Georgia.
    """
    ...
    SAVE_LOCATION = 'data/plots/georgia'
    DATA_LOCATION = 'data/cleaned/georgia.csv'
