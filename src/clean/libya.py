...
class Libya(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Libya.
    """
    ...
    SAVE_LOCATION = 'data/plots/libya'
    DATA_LOCATION = 'data/cleaned/libya.csv'
    FILENAME = 'libya.png'
