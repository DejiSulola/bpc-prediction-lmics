...
class LaoPeopleDemocraticRepublic(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing LaoPeopleDemocraticRepublic.
    """

    YEARS_AT_SCHOOL = 'c4'
    LEVEL_OF_EDUCATION = 'c5'
    MARITAL_STATUS = 'c7'
    COUNTRY = 'lao_people_democratic_republic'
    SEX = 'sex'
    AGE = 'age'
    YEARS_AT_SCHOOL = 'c4'
    LEVEL_OF_EDUCATION = 'c5'
    ...
    SAVE_LOCATION = 'data/plots/lao_people_democratic_republic'
    DATA_LOCATION = 'data/cleaned/lao_people_democratic_republic.csv'
    FILENAME = 'lao_people_democratic_republic.png'
