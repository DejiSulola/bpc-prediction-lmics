...
class Moldova(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Moldova.
    """
    ...
    SAVE_LOCATION = 'data/plots/moldova'
    DATA_LOCATION = 'data/cleaned/moldova.csv'
    FILENAME = 'moldova.png'
