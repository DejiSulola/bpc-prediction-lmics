...
class Mauritania(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Mauritania.
    """
    ...
    SAVE_LOCATION = 'data/plots/mauritania'
    DATA_LOCATION = 'data/cleaned/mauritania.csv'
    FILENAME = 'mauritania.png'
