...
class Myanmar(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Myanmar.
    """
    ...
    SAVE_LOCATION = 'data/plots/myanmar'
    DATA_LOCATION = 'data/cleaned/myanmar.csv'
    FILENAME = 'myanmar.png'
