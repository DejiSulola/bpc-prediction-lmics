...
class TimorLeste(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Timor-Leste.
    """
    ...
    SAVE_LOCATION = 'data/plots/timor-leste'
    DATA_LOCATION = 'data/cleaned/timor-leste.csv'
    FILENAME = 'timor-leste.png'
