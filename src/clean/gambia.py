...
class Gambia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Gambia.
    """
    ...
    SAVE_LOCATION = 'data/plots/gambia'
    DATA_LOCATION = 'data/cleaned/gambia.csv'
    FILENAME = 'gambia.png'
