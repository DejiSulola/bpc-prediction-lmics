...
class Mozambique(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Mozambique.
    """
    ...
    TIME_SEDENTARY_HOURS = 'p13a'
    TIME_SEDENTARY_MINUTES = 'p13b'
    ...
    SAVE_LOCATION = 'data/plots/mozambique'
    DATA_LOCATION = 'data/cleaned/mozambique.csv'
