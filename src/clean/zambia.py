...
class Zambia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Zambia.
    """
    ...
    SAVE_LOCATION = 'data/plots/zambia'
    DATA_LOCATION = 'data/cleaned/zambia.csv'
    FILENAME = 'zambia.png'
    ...
    def earnings_per_year(self, new_var, earning_type, earnings, conversion_factor):
        ...
        try:
            ...
            if earning_type == 1:
                earnings_per_year = self.data[earnings] * 52.1429 # weeks to year
            elif earning_type == 2:
                earnings_per_year = self.data[earnings] * 12 # months to year
            elif earning_type == 3:
                earnings_per_year = self.data[earnings] # year
            else:
                earnings_per_year = np.nan

            # Convert to numeric and divide by conversion factor
