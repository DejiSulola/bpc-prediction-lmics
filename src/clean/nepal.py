...
class Nepal(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Nepal.
    """
    ...
    LEVEL_OF_EDUCATION = 'c5'
    WORK_STATUS = 'c8'
    PPL_IN_HOUSEHOLD = 'c9x1'
    EARNING_TYPE = 'c10type'
    EARNINGS = 'c10'
    CONVERSION_FACTOR = 132.659
    ...
    SAVE_LOCATION = 'data/plots/nepal'
    DATA_LOCATION = 'data/cleaned/nepal.csv'
    FILENAME = 'nepal.png'
