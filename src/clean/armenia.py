...
class Armenia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Armenia.
    """
    ...
    SAVE_LOCATION = 'data/plots/armenia'
    DATA_LOCATION = 'data/cleaned/armenia.csv'
    FILENAME = 'armenia.png'
