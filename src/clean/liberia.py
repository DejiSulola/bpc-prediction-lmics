...
class Liberia(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Liberia.
    """
    ...
    SAVE_LOCATION = 'data/plots/liberia'
    DATA_LOCATION = 'data/cleaned/liberia.csv'
    FILENAME = 'liberia.png'
