...
class SriLanka(BaseCleaner):
    """
    A concrete implementation of the Preprocessor interface for preprocessing Sri Lanka.
    """
    ...
    SAVE_LOCATION = 'data/plots/sri_lanka'
    DATA_LOCATION = 'data/cleaned/sri_lanka.csv'
    FILENAME = 'sri_lanka.png'
